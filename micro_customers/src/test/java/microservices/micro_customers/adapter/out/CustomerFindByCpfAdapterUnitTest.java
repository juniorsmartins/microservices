...
@DisplayName("Unit - CustomerFindByCpfAdapter")
class CustomerFindByCpfAdapterUnitTest extends AbstractTestcontainersTest {
    ...
    @Test
    @DisplayName("nulo")
    void dadoCpfNulo_quandoFindByCpf_entaoLancarException() {
        Executable acao = () -> this.customerFindByCpfAdapter.findByCpf(null);
