...
@DisplayName("Unit - CustomerUpdateAdapter")
class CustomerUpdateAdapterUnitTest extends AbstractTestcontainersTest {
    ...
    void dadoCustomerNulo_quandoUpdate_entaoLancarException() {
        Executable acao = () -> this.customerUpdateAdapter.update(null);
