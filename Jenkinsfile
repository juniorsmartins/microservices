...
//                         sh "cd ${project} && ./gradlew sonar"
                        sh "cd ${project} && ${sonarqubeScanner}/bin/sonar-scanner -e sonar.projectKey=jenkins_mercado_financeiro sonar.host.url=http://localhost:9000/ sonar.login=squ_35c655e2667a2228326356b315a3cfec80a8c92d"
                    }
                }
            }
        }
